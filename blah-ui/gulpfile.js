...
gulp.task('copy', function() {
  ...
  gulp.src('./components/recommendation/recommendation.js')
    .pipe(gulp.dest('./assets/js'))
  gulp.src('./components/similarity/similarity.js')
    .pipe(gulp.dest('./assets/js'))
  gulp.src('./components/chart/chart.js')
    .pipe(gulp.dest('./assets/js'))
  gulp.src('./components/funnel/funnel.js')
    .pipe(gulp.dest('./assets/js'))
  gulp.src('./components/user/user.js')
    .pipe(gulp.dest('./assets/js'))
  gulp.src('./components/segmentation/segmentation.js')
    .pipe(gulp.dest('./assets/js'))
  gulp.src('./components/count/count.js')
    .pipe(gulp.dest('./assets/js'))
})
